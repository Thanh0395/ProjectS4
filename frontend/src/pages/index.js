...
export { default as LessonAdmin } from './admin/lesson/LessonAdmin';
...
export { default as CategoryAdminCreate } from './admin/category/CategoryAdminCreate';
export { default as CategoryAdminUpdate } from './admin/category/CategoryAdminUpdate';
