                        ...
                        >
                            <SwiperSlide>
                                <div className="pricing-single basic">
                                    ...
                                    <div className="price price-month">
                                        ...
                                        <div className="year">
                                            $<span className="number">120.00</span><sup>/yr</sup>
                                        </div>
                                    </div>
                            ...
                            <SwiperSlide>
                                <div className="pricing-single standard">
                                    ...
                                    <div className="price price-month">
                                        <div className="month">
                                            $<span className="number">15.00</span><sup>/mo</sup>
                                        </div>
                                        <div className="year">
                                            $<span className="number">180.00</span><sup>/yr</sup>
                                        </div>
                                    </div>
                            ...
                            <SwiperSlide>
                                <div className="pricing-single premium">
                                    ...
                                    <div className="price price-month">
                                        <div className="month">
                                            $<span className="number">20.00</span><sup>/mo</sup>
                                        </div>
                                        <div className="year">
                                            $<span className="number">240.00</span><sup>/yr</sup>
                                        </div>
                                    </div>
